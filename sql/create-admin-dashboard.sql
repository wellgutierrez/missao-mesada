...
comment on function public.get_admin_users() is 'Lista usuarios administrativos para owners.';
comment on function public.upsert_admin_user_by_email(text, text, text) is 'Cria ou atualiza administradores por email, restrito a owners.';

-- Exemplo para liberar seu usuario admin:
